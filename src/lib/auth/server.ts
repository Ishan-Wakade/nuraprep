...
const ipAddressConfiguration =
  environment.DEPLOYMENT_PLATFORM === "VERCEL"
    ? {
        // Vercel overwrites this platform-owned header before the request reaches
        // the application, so client-supplied forwarding values are not trusted.
