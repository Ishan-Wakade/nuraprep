...
The pass did not supply genuine owner decisions for four records whose latest notes still identify them as E2E-only fixture approvals. Those records remain a human-review gate. As before, every content correction creates a new immutable version whose earlier decision does not transfer.
